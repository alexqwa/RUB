...
export default function SignUpFinished() {
  return (
    <View className="flex-1 relative items-center justify-center bg-shape_purple">
      <Finished />
      ...
      <TouchableOpacity
        ...
        className="absolute bottom-20 h-14 bg-shape_active w-full max-w-[85%] rounded-lg items-center justify-center"
      >
